                                    ...
                                    <Row className=''>
                                        <Col xs={12} lg={6} className='text-center'>
                                            <div className='mb-3 getimg' >
                                                <img src={img?img:ele.thumbnail} className='me-4' style={{ borderRadius: '20px', width: '60%', objectFit: 'cover' }}></img>

                                            </div>
                                            <button onClick={()=>dispatch(carthandler(ele))}>Add to cart</button>
                                                        ...
                                                        return (
                                                            <Col >
                                                                <div className='mt-5 getimg-hover' >
                                                                    <img src={ele} className='w-100' onClick={()=>dataimage(ele,ind)} style={{ cursor: 'pointer' }} ></img>
                                                                </div>
                                                            </Col>
                                                        )
                                                    })
